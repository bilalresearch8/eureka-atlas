const CACHE = 'eureka-atlas-v14-shell';
const SHELL = ['./','./index.html','./manifest.webmanifest','./assets/icons/eureka-atlas.svg','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
